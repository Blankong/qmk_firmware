...
led_config_t g_led_config = {
	...
	{  73,74,75,NO_LED,NO_LED,76,NO_LED,77,78,79,80,81,59,45},
	},
    { // LED Index to Physical Position
		// x = 224 / (NUMBER_OF_COLS - 1) * COL_POSITION
		// y = 64 / (NUMBER_OF_ROWS - 1) * ROW_POSITION
		{ 6, 0  },{ 16, 0  },{ 24, 0  },{ 36, 0  },{ 48, 0  },{ 64, 0  },{ 80, 0  },{ 96, 0  },{ 112, 0  },{ 128, 0  },{ 144, 0  },{ 160, 0  }, { 176, 0  },{ 192, 0  },{ 208, 0  },
		...
		{ 6, 64 },{ 16, 64 },{ 24, 64 },{ 48, 64 },{ 96, 64 },{ 112, 64 },{ 176, 64 },{ 192, 64 },{ 208, 64 },{ 0, 0 },
